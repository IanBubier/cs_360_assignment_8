...
print('\nTest program requests account creation. Microservice creates account and replies.')
...
socket.send_string(request)
reply = socket.recv_string()
print('\nTest program requests account data update. Microservice updates specified account data and replies.')
print(json.loads(reply))
time.sleep(10)
...
socket.send_string(request)
reply = socket.recv_string()
print('\nTest program requests specific account data and microservice replies with specified data.')
print(json.loads(reply))
time.sleep(10)
...
socket.send_string(request)
reply = socket.recv_string()
print('\nTest program requests deletion of specific account data. Microservice deletes specified data and replies.')
print(json.loads(reply))
time.sleep(10)
...
socket.send_string(request)
reply = socket.recv_string()
print('\nTest program requests account deletion. Microservice deletes account and replies.')
print(json.loads(reply))
time.sleep(10)
...
socket.send_string(request)
reply = socket.recv_string()
print('\nTest program requests end of microservice and microservice ends.')
print(json.loads(reply))
